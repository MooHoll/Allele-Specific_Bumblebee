...
#my_genes <- read.csv("ASE_genes_in_repro_only.txt",header=F)
#my_genes <- read.csv("ASE_genes_in_sterile_only.txt",header=F)
my_genes <- read.csv("ASE_genes_in_both.txt",header=F)
...
#1/1 (for repro only ASE)
#5/5 (for sterile only ASE)
#43/92  (for both ASE)
...
#write.table(REVIGO,"enriched_GOs_ASE_repro_only.txt",row.names = F,sep = "\t",quote = F)
#write.table(REVIGO,"enriched_GOs_ASE_sterile_only.txt",row.names = F,sep = "\t",quote = F)
write.table(REVIGO,"enriched_GOs_ASE_both.txt",row.names = F,sep = "\t",quote = F)
