...
GO_annotations <- read.table("../Bumble_bee_ensemble_GO_terms.txt", header = T)
...
my_genes <- read.csv("./Gene_Lists/ASM_and_ASE_genes.txt",header=T)
...
write.table(REVIGO,"enriched_8_genes_ASM_ASE.txt",row.names = F,sep = "\t",quote = F)
